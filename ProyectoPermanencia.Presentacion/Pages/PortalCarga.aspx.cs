...
{
    public partial class PortalCarga : System.Web.UI.Page , IMensajeAlerta
    {
        ...
        {
            string opcion = this.ddlTipoArchivoASubir.SelectedValue; //Obtiene el valor de la opcion que eligio el usuario desde el DropDownLisr
