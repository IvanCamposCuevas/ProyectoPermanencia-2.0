            ...
            <div class="row" style="height: 90px">
                ...
                <div class="col-sm-4 filtrobox" style="margin-left:0px; padding-left:0px; height:90px">
                    ...
                    <div id="Carrera" style="width: 100px; ">
                        ...
                        <asp:SqlDataSource ID="sqlCarrera" runat="server" ConnectionString="<%$ ConnectionStrings:Permanencia_2ConnectionString3 %>" SelectCommand="SELECT DISTINCT * FROM [LK_Carrera] ORDER BY [Desc_Carrera]"></asp:SqlDataSource>
                    </div>
                </div>
                <!-- Filtrar resultados -->
