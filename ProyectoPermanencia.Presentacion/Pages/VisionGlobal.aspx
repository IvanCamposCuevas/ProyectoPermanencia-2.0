            ...
            <div class="row" style="height: 90px">
                ...
                <div class="col-md-4 filtrobox">
                    ...
                    <div id="Escuela" style="width: 100px; align-self: center;">
                        ...
                        <asp:SqlDataSource ID="sqlEscuela" runat="server" ConnectionString="<%$ ConnectionStrings:Permanencia_2ConnectionString %>" SelectCommand="SELECT DISTINCT * FROM [LK_Escuela]"></asp:SqlDataSource>
                    </div>
                </div>
                ...
                <div class="col-md-4 filtrobox">
                    ...
                    <div id="Carrera" style="width: 100px; ">
                        ...
                        <asp:SqlDataSource ID="sqlCarrera" runat="server" ConnectionString="<%$ ConnectionStrings:Permanencia_2ConnectionString %>" SelectCommand="SELECT DISTINCT * FROM [LK_Carrera]"></asp:SqlDataSource>
                    </div>
                </div>
                <!-- Filtrar resultados -->
